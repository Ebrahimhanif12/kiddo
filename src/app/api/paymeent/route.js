...
export async function POST() {
    ...
    try {
       ...
       const init_url='https://sandbox.sslcommerz.com/gwprocess/v4/api.php';
        ...
        formData.append("store_id", "kiddo69136b581eecd");
        formData.append("store_passwd", "kiddo69136b581eecd@ssl");
        formData.append("total_amount", "50");
        formData.append("currency", "BDT");
        formData.append("tran_id", `${tran_id}`);
        formData.append("success_url",`http://localhost:3000/api/success`);
